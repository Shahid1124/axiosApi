  ...
  return (
    <div className='container my-4'>
      ...
      <div className="container d-flex justify-content-between">
        ...
        <button disabled={pageCount >= Math.ceil(NewsData.length/test())} className='btn btn-dark btn-sm' onClick={handleNextPage}>Next &rarr;</button>        
      </div>
